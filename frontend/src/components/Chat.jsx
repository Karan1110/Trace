...
const Chat = () => {
  ...
  return (
    <>
                  ...
                  <DropdownMenu.Root>
                    ...
                    <DropdownMenu.Content>
                      ...
                      <Dialog.Root>
                        ...
                        <Dialog.Content style={{ maxWidth: 450 }}>
                          <Dialog.Title>Invite - {chatData.name}</Dialog.Title>
                          <Dialog.Description size="2" mb="4">
                            Invite a member
                          </Dialog.Description>
                          ...
                          <Flex direction="column" gap="3">
                            ...
                            <Flex direction="row ">
                              ...
                              <IconButton
                                ...
                                onClick={() =>
                                  copyToClipboard(
                                    `http://localhost:1111/chat/invite/${chatData.inviteCode}`
                                  )
                                }
                              >
                                <svg
                            ...
                            <Flex direction="row">
                              <Text> update the server's invite code</Text>
                              <IconButton
                                size="1"
                                ml="2"
      ...
      {id && chatData && (
        <div className="p-5 ">
          <div className="flex flex-col p-4 space-x-5 space-y-5 h-[500px] absolute top-32  left-96">
            {selectedChannel && selectedChannel.type == ("video" || "audio") ? (
